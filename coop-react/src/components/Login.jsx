...
const styles = {
  ...
  card: { background: '#ffffff', padding: 'clamp(24px, 6vw, 40px) clamp(18px, 5vw, 35px)', borderRadius: '12px', boxShadow: '0 15px 35px rgba(0, 0, 0, 0.2)', width: '100%', maxWidth: '420px', borderTop: '6px solid #003366' },
  header: { textAlign: 'center', marginBottom: '30px' },
  title: { margin: '0 0 8px 0', color: '#003366', fontSize: 'clamp(23px, 7vw, 28px)', lineHeight: 1.2, fontWeight: '800' },
  subtitle: { margin: 0, color: '#6c757d', fontSize: '15px' },
  form: { display: 'flex', flexDirection: 'column', gap: '20px' },
  inputGroup: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { fontSize: '13px', fontWeight: '600', color: '#495057' },
  input: { padding: '12px 16px', borderRadius: '8px', border: '1px solid #ced4da', fontSize: '16px', backgroundColor: '#f8f9fa', transition: 'all 0.2s ease-in-out', width: '100%', boxSizing: 'border-box' },
