...
const styles = {
  ...
  card: { background: '#ffffff', padding: 'clamp(22px, 5vw, 35px)', borderRadius: '12px', boxShadow: '0 15px 35px rgba(0, 0, 0, 0.2)', width: '100%', maxWidth: '640px', borderTop: '6px solid #003366' },
  header: { textAlign: 'center', marginBottom: '25px' },
  title: { margin: '0 0 8px 0', color: '#003366', fontSize: 'clamp(22px, 6vw, 26px)', fontWeight: '800', lineHeight: 1.2 },
  subtitle: { margin: 0, color: '#6c757d', fontSize: '15px' },
  form: { display: 'flex', flexDirection: 'column', gap: '15px' },
  grid2: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 230px), 1fr))', gap: '15px' },
  ...
  input: { padding: '10px 14px', borderRadius: '8px', border: '1px solid #ced4da', fontSize: '16px', backgroundColor: '#f8f9fa', transition: 'all 0.2s ease-in-out', width: '100%', boxSizing: 'border-box' },
